...
int main (){
	...
	//Erstelle nötige Strukturen für die Matrizen A1, A2, A3
	struct matrix mA1;
	struct matrix mA2;
	struct matrix mA3;


	//Erstelle nötige Strukturen für die Initial Condition Vektoren (AB's)
	struct vector vIC1;
	struct vector vIC2;
	struct vector vIC3;
	...
	//Wichtige Konstanten für die Berechnung mit der Fkt. RungeKuttta4 (Schrittweite h & Sim.Zeit)
