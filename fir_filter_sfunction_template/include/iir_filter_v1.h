/** \file iir_filter_v1.h
 *
 *  \brief Headerfile mit Datenstruktur und Zugriffsfunktionen fuer iir-Filter
 *
 *  \details In diesem Header wird die Datenstruktur `struct iir_filter_variablen` definiert,
 *  welche interne Groessen des iir-Filters aufnimmt. Ausserdem werden Funktionsprototypen
 ...
 *  der Funktionen der iir_filter_lib auf.
 */
...
/** \brief Die Struktur `struct iir_filter_variablen` enthaelt die internen Variablen
 *  eines iir-Filters.
 */
struct iir_filter_variablen {
